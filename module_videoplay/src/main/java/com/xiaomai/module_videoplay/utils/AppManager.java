...
//                FocusShowOverlayView overlayView = new FocusShowOverlayView(activity);
//                ((ViewGroup) activity.getWindow().getDecorView()).addView(overlayView, new ViewGroup.LayoutParams(-1, -1));
//                activity.getWindow().getDecorView().getViewTreeObserver().addOnGlobalFocusChangeListener((v, hasFocus) -> {
//                    if (hasFocus == null) {
//                        focusRect.set(0, 0, 0, 0);
//                    } else {
//                        hasFocus.getGlobalVisibleRect(focusRect);
//                    }
//                    overlayView.setNewViewRect(focusRect);
//                });
//            }
        }
